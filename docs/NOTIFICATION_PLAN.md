...
━━━━━━━━━
디지털스토어 (사업자번호 213-07-74335)
support@digitalst.kr
```

※ 본문+footer 합계 800자 이내 유지(알림톡 1000자 제한 대비). 초과 시 본문 줄임.
...
※ 발신자명은 "디지털스토어" 로 통일. 본문+footer 800자 이내 유지.
