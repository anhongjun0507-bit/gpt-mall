...
NEXT_PUBLIC_SITE_URL=https://gpt-mall.vercel.app   # 이메일 redirectTo 베이스
```
...
- Site URL: `https://gpt-mall.vercel.app`
- Redirect URL 화이트리스트: `http://localhost:3000/**`, `https://gpt-mall.vercel.app/**`, `https://*-hyunseoks-projects-511caaf3.vercel.app/**`
...
- 사용 API: **네이버 로그인**
- 서비스 URL: `https://gpt-mall.vercel.app`
- 콜백 URL: `https://gpt-mall.vercel.app/auth/naver/callback`
