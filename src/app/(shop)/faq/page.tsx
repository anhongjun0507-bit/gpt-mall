...
const FAQ_ITEMS: { q: string; a: string }[] = [
  {
    q: "상품은 어떤 방식으로 제공되나요?",
    a: "상품에 따라 활성화 링크 방식 또는 개별 이용 계정 지급 방식으로 제공됩니다. 구체적인 제공 방식은 주문 확인 후 안내드립니다.",
  },
  {
    q: "활성화 링크 방식은 어떻게 이용하나요?",
    a: "안내드리는 활성화 링크를 통해 회원님의 계정에 이용권이 적용되며, 구체적인 적용 방법은 발급 시 함께 안내드립니다.",
  },
  {
  ...
  },
  {
    ...
    a: "개별 이용 계정 지급 방식으로 제공되는 상품은 계정을 받으신 뒤 비밀번호를 직접 변경하고 OTP(일회용 비밀번호)를 설정해 두시기를 권해 드립니다.",
  },
  {
    q: "계정에 등록된 이메일 주소를 바꿔도 되나요?",
    a: "개별 이용 계정 지급 방식으로 제공되는 상품의 경우, 계정에 등록된 이메일 주소를 변경하시면 이용에 제한이 생길 수 있어 권해 드리지 않습니다. 변경이 꼭 필요하시면 먼저 카카오톡 채널로 문의해 주세요.",
  },
  {
    q: "제 개인정보가 다른 사람에게 노출되지는 않나요?",
    a: "개별 이용 계정 지급 방식으로 제공되는 상품은 회원님이 평소 사용하시던 개인 계정과는 분리된 별도 계정이므로, 기존 개인 계정에 담긴 정보와는 무관하며, 기존 계정의 데이터가 함께 넘어가지 않습니다.",
  },
  {
