...
const FAQ_ITEMS: { q: string; a: string }[] = [
  {
    ...
    a: "상품에 따라 다릅니다. 회원님의 계정을 가족 그룹에 초대해 드리는 방식이 있고, 회원님 혼자 사용하시는 단독 이용 계정을 발급해 드리는 방식이 있습니다. 어떤 방식인지는 각 상품 상세 페이지의 설명에서 확인하실 수 있습니다.",
  },
  {
    q: "주문 후 발급까지 얼마나 걸리나요?",
    a: "입금이 확인되는 대로 접수된 순서에 따라 순차적으로 발급해 드립니다. 주문 접수는 연중무휴 24시간 받고 있으며, 발급이 완료되면 안내드립니다.",
  },
  {
    q: "이미 다른 가족 그룹에 속해 있는데 이용할 수 있나요?",
    a: "최근 12개월 안에 가족 그룹을 변경하신 이력이 있으면 초대가 제한될 수 있습니다. 주문하시기 전에 현재 소속된 그룹과 변경 이력을 먼저 확인해 보시기를 권해 드립니다.",
  },
  {
  ...
  },
  {
    ...
    a: "단독 이용 상품은 계정을 받으신 뒤 비밀번호를 직접 변경하고 OTP(일회용 비밀번호)를 설정해 두시기를 권해 드립니다. 가족 그룹 초대 방식은 회원님이 쓰시던 계정을 그대로 사용하시므로 따로 변경하실 것이 없습니다.",
  },
  {
  ...
  },
  {
    ...
    a: "이용 기간 중 회사의 귀책사유로 계정 이용이 불가능해진 경우에는 대체 계정을 제공해 드리거나 잔여 기간에 상응하는 이용 기간을 연장해 드립니다(이용약관 제11조 2항). 문제가 생기면 카카오톡 채널로 알려 주세요.",
  },
  {
